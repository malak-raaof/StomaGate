...
public class RandomMeal implements Serializable {
    ...
    public void extractIngredientsAndMeasures() {
        //Log.d("RandomMeal", "🔍 Extracting ingredients from: " + new Gson().toJson(this));
        ...
        for (int i = 1; i <= 20; i++) { // TheMealDB API supports up to 20 ingredients
            try {
                ...
                if (ingredient != null && !ingredient.trim().isEmpty()) {
                    ...
                    measures.add(measure != null ? measure : ""); // Avoid null measures
                }
            } catch (NoSuchFieldException | IllegalAccessException e) {
                e.printStackTrace();
                Log.e("RandomMeal", "⚠️ Error extracting ingredient " + i, e);
            }
        }

        //Log.d("RandomMeal", "Extracted ingredients: " + ingredients);
        //Log.d("RandomMeal", "Extracted measures: " + measures);
    }
